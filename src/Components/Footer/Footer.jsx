...
const Footer = () => {
  ...
  return (
    <div className="bottom-0">
      <footer>
        <hr className="mt-10 w-5/6 mx-auto  border-gray-400" />
        <div className="relative mx-auto overflow-hidden w-full max-w-screen-xl px-4 py-8 lg:py-8">
            ...
            <div className="mx-auto">
              ...
              <div className="sm:flex sm:items-center sm:justify-between mt-4">
                <span className="text-sm text-black sm:text-center">
                  ...
                  | Crafted with 💖 by{" "}
                  <a
                    href="https://www.pgdavhyperion.in/society/techwhiz"
                    target="__blank"
                    className="hover:underline"
                  >
                    Techwhiz
          ...
          {width < breakpoint ? (
            ...
            // Display svg for desktop - removed absolute positioning
            <svg
              className="w-full absolute -top-1/3 h-full -z-10 mx-auto mt-8"
              width="2745"
              height="488"

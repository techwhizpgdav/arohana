              ...
              {({ isValid, values, setFieldValue }) => (
                <Form>
                  <div className=" flex flex-col gap-4 items-center">
                    ...
                    <p className="flex font-semibold ">UPI ID: {upi_id}</p>
                    <div>
                      <input
                        id="screenshot"
                        name="screenshot"
                    ...
                    <p>Upload a screenshot of the payment</p>
                    <Field
                      type="text"
                      id="remarks"
                      placeholder={ event.remarks_label ? event.remarks_label : "Remarks if any" }
                      name="remarks"
                      className="w-72 h-12 bg-slate-700 border-2 border-gray-800 rounded-md p-4 placeholder:text-white text-white"
                    />

    ...
    return (
      <>
            ...
            <div className="container mx-auto px-6 md:px-12 xl:px-32">
              <div className="mb-16 text-center">
                ...
                <p className="text-gray-600 lg:w-8/12 lg:mx-auto">
                  Dedicated professionals guiding our team and inspiring
                  success.
                </p>
              </div>
              <div className="grid gap-12 items-center md:grid-cols-3">
                <div className="space-y-4 text-center">
                  <img
                    ...
                    src="https://www.pgdavhyperion.in/assets/images/hyperion/mentor.jpg"
                    alt="Dr. Aparna Datt"
                    loading="lazy"
                    width="640"
                    height="805"
                ...
                <div className="space-y-4 text-center">
                  <img
                    ...
                    src="https://pgdavplacementcell.in/images/Principal1.webp"
                    alt="pricipal"
                    loading="lazy"
                    width="1000"
                    height="667"
                ...
                <div className="space-y-4 text-center">
                  <img
                    className="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
                    src="https://www.pgdavcollege.in/files/userImg/146/User-Image-a5e00132373a7031000fd987a3c9f87b-daacea63cf50d67497d061a43fea777c.JPG"
                    alt="Mr. Jagannath Kashyap"
                    loading="lazy"
                    width="1000"
                    height="667"
                  />
            ...
            <div className="container mx-auto px-6 md:px-12 xl:px-32">
              ...
              <div className="grid gap-12 items-center md:grid-cols-3">
                ...
                <div className="space-y-4 text-center">
                  <img
                    className="w-64 h-64 mx-auto object-cover rounded-xl md:w-40 md:h-40 lg:w-64 lg:h-64"
                    src="https://i.pinimg.com/736x/a9/28/09/a92809b1860bc5e77faebbb7acebf1a2.jpg"
                    alt="woman"
                    loading="lazy"
                    width="640"
                    height="805"
        ...
        <div className="flex justify-center mx-4 flex-col sm:flex-row">
          <button
            className={`mr-4 px-6 py-3 mb-4 sm:mb-0 w-full font-bold rounded-lg shadow-lg whitespace-normal ${
              activeTab === "core_team"
          ...
          <button
            className={`px-6 py-3 w-full font-bold rounded-lg shadow-lg whitespace-normal ${
              activeTab === "web_developer"
                ? "bg-yellow-500 text-white hover:scale-105"
                : "bg-gray-300 text-gray-700 hover:bg-gray-400"
            }`}

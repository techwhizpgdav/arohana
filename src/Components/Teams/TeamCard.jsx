...
const TeamCard = ({ member }) => {
    ...
    return (
        <div className="team-card text-center">
            <div style={{ borderColor }} className="border-x-4 border-y-4 rounded-full p-1 inline-block">
                <div className="border border-white rounded-full p-1">
                    <img
                        src={photo || "https://i.pinimg.com/736x/a9/28/09/a92809b1860bc5e77faebbb7acebf1a2.jpg"}
                        alt={name}
                ...
                <div className="mt-4 space-x-4">
                    {instagram && (
                        <a href={instagram} target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-instagram text-xl text-gray-600 hover:text-yellow-500"></i>
                        </a>
                    )}
                    {linkedin && (
                        <a href={linkedin} target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-linkedin text-xl text-gray-600 hover:text-yellow-500"></i>
                        </a>
                    )}
                    {github && (
                        <a href={github} target="_blank" rel="noopener noreferrer">
                            <i className="fab fa-github text-xl text-gray-600 hover:text-yellow-500"></i>
                        </a>
                    )}
                </div>
            </div>

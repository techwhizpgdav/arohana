  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="font-bold uppercase text-lg md:text-4xl mb-4 text-black max-w-4xl">
          Changelog from my journey
        </h2>
        <p className="text-black text-sm md:text-base max-w-sm">
        ...
        {data.map((item, index) => (
          ...
          >
            ...
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-10 absolute left-4 md:left-4 w-10 rounded-full bg-white dark:bg-black flex items-center justify-center">
...
<div>
  ...
  <div className="group relative flex gap-x-5">
    ...
    <div className="grow pb-8 group-last:pb-0">
      ...
      <div className="mt-3">
        {/* <!-- Card --> */}
        <a className="block border border-gray-200 rounded-lg hover:shadow-sm focus:outline-none" href="#">
...
{/* <!-- End Timeline --> */}
        ...
        {/* this is ray tracing beams */}
        <div
          style={{
            height: height + "px",
          }}
          className="absolute md:left-8 -left-4 top-0 overflow-hidden w-[10px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0  w-[10px] bg-gradient-to-t from-fuchsia-500 via-blue-500 to-transparent from-[0%] via-[10%] rounded-full"
          />
        </div>
      </div>
    </div>

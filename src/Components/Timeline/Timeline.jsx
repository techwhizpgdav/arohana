  ...
  const data = [
    {
      ...
      content: (
        <div>
          <p
            className="text-black text-xs md:text-2xl font-normal mb-8">
    ...
    },
    {
      ...
      content: (
        <div>
          <p
            className="text-black dark:text-neutral-200 text-xs md:text-sm font-normal mb-8">
    ...
    },
    {
      ...
      content: (
        <div>
          <p
            className="text-black dark:text-neutral-200 text-xs md:text-sm font-normal mb-4">
